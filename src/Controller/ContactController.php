...
final class ContactController extends AbstractController
{
    ...
    public function testOvhMail(): Response
    {
        ...
        try {
            ...
            $transport = Transport::fromDsn('smtp://contact@camping-de-la-chalaronne.fr:Sandrinepanchaud2026%21@smtp.mail.ovh.net:587?encryption=tls&auth_mode=login');
